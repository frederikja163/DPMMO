...
execute as @a if predicate dpmmo:wearing_woodcutting_tool run function dpmmo:powerup/tree_cutter/wearing_tool {"skill": "dpmmo_woodcutting", "display": "🪓 Woodcutting"}